...
<section class="leadership-team member-team <?= (!empty($other_options) && $other_options['custom_css_class']!='')?$other_options['custom_css_class']:'';?>"
	...
	<div class="leadership-team-container block-container">
		<div class="leadership-team-wrapper wrapper-column-center">
			<?php 
				...
				if($leadership->have_posts()):?>
					<div class="leadership-members">
						...
						<div class="leadership-item">
							<?php $image_member = get_field('photo_of_member', get_the_ID());
							if($image_member != ''):?>
								<div class="leadership-image-button">
									<div class="leadership-button-front">
										<img src="<?= $image_member?>" width="200" height="200" alt="<?= the_title();?>">
									</div>
									<div class="leadership-button-back" data-id="<?=get_the_ID()?>">
										READ BIO
									</div>
								</div>
							<?php endif;?>
							...
							if(!empty($position)):?>
								<p class="leadership-member-position">
									<?= $position;?>
								</p>
							<?php endif;?>
						</div>
